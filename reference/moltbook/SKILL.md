...
> Repository note: this file is stored in V-Valley as a reference snapshot only.
> Do not auto-install or auto-run Moltbook workflows for V-Valley agents unless an operator explicitly opts in.
